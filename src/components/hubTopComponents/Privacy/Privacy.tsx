        ...
        <section className={Styles.terms_section}>
          ...
          <div>
            <div className={Styles.terms_container}>
              <div>
                <p>
                  プライバシーノーティス 1. 本ノーティスについて
                  Scalably株式会社（以下「当社」といいます。）は、全ての適用法及び将来それらに取って代わる法に従い、お客様の個人データを処理します。本ノーティスでは、お客様の個人データの処理に関連する法に基づく情報を記載しています。本ノーティスに基づき、当社は、お客様が当社に提供する、又は他の情報源から当社が取得するあらゆる個人データを処理します。本ノーティスを必ずお読みになり、ご理解いただきますようお願いいたします。
                  一部の個人データは、当社が発行するその他のプライバシーポリシーの対象となることがあります。この場合、当該プライバシーポリシーの定めが本ノーティスの定めと矛盾する場合には、本ノーティスが当該その他のプライバシーポリシーに優先します。
                  2. 定義 本ノーティスにおいて、
                  お客様の「個人データ」とは、識別された又は識別可能な自然人（以下「データ主体」といいます。）に関するあらゆる情報をいいます。
                  「処理」とは、自動的な手段によるか否かを問わず、収集、記録、編集、構成、記録保存、調整若しくは変更、検索、参照、使用、送信による開示、配布、又は、それら以外の方法で利用可能なものとすること、整列若しくは結合、制限、消去若しくは破壊のような、個人データ若しくは一連の個人データに実施される作業又は一連の作業をいいます。
                  「管理者」とは、自然人又は法人、公的機関、部局又はその他の組織であって、単独又は他の者と共同で個人データの処理の目的及び手段を決定する者をいいます。
                  3. 当社が収集する個人データ及びお客様の個人データの収集方法
                  ...
                  4. 個人データの処理に係る法的根拠及び目的 当社は、以下の法的根拠に基づき、お客様の個人情報を処理します。 (a)
                  法的義務　当社が法的義務の遵守を義務づけられる場合を指します。 (b)
                  契約の履行　お客様が当事者である契約を履行するため又は契約締結前にお客様の要請に応じて一定の手段を講じるために、お客様の個人データを処理する必要がある場合を指します。
                  (c)
                  正当な利益　お客様の個人データの処理が、当社の事業の促進など、当社又は第三者が求める正当な利益に必要な場合であって、お客様の利益及び基本的権利がそれらの利益に優先しない場合を指します。
                  (d)
                  同意　当社がお客様の個人データを処理することについてお客様が同意した場合を指します。ただし、当社がお客様から当該同意を取得した場合であっても、当社はその他の法的根拠に基づいてお客様の個人データを処理することがあります。なお、お客様による同意の撤回（本ノーティスの下記第9項(g)をご覧ください。）は、その撤回前の同意に基づく、当社によるお客様の個人データの処理の適法性に影響を与えません。
                  ...
                  当社に適用されるあらゆる法令の遵守（法的義務に基づきます。）
                  管轄権を有するデータ保護当局及び行政調査又は犯罪調査に携わる機関を含む、関連する政府当局及び部局との協力（法的義務又は正当な利益に基づきます。）
                  当社は、お客様の「センシティブデータ」（すなわち、お客様の人種、種族的出身、宗教、身体的若しくは精神的健康、政治的意見、性的指向、実際の犯罪若しくは犯罪の疑い、又は遺伝子データ及び生体データに関する情報）の処理は行いません。
                  5. 受領者への個人データの開示 当社は、お客様の個人データを、以下の類型の受領者と共有することがあります。
                  ...
                  (b) 受領者が、欧州委員会及び/又は英国政府が承認した標準データ保護条項を当社と締結していること。
                  ...
                  (a)
                  お客様に係る個人データの処理に関する情報を取得する権利、及びお客様に関して当社が保有している個人データにアクセスする権利
                  (b) お客様の個人データが不正確又は不完全である場合に、当社に対して訂正を要求する権利 (c)
                  特定の状況において、お客様の個人データの消去を当社に対して要求する権利。特定の状況には以下の状況が含まれます（ただし、これらに限定されるものではありません。）。
                  (ⅰ) 当社がお客様の個人データを収集した目的に照らし、当社がお客様の個人データを保持する必要がなくなった場合。 (ⅱ)
                  ...
                  12. 連絡先 本ノーティスに関するご質問、ご意見又はご要望がある場合は、下記の連絡先にお問い合わせください。 管理者（当社）：
                  会社名：Scalably株式会社 代表取締役：山本純矢 本社所在地：東京都港区虎ノ門4丁目1－6 第二大石ビル5階
                  電子メールアドレス：info@scalably.com クッキーポリシー
                  ...
                  当社のウェブサイトは、以下の必須のクッキーを使用しています。 クッキー名 ソース 利用目的・説明 有効期限
                  wp-wpml_current_language 【クッキー発行元ドメインを記載】 現在表示している言語を保持します。 0日
                  wordpress_logged_in_df9616759138eda30207b5739f0c341d 【クッキー発行元ドメインを記載】
                  現在の訪問者がログイン中のユーザーかどうかを確認するのに使われます。 14日 wordpress_test_cookie
                  【クッキー発行元ドメインを記載】 ブラウザーがCookie を受け入れるかをテストします。 0日
                </p>
              </div>
            </div>
          </div>

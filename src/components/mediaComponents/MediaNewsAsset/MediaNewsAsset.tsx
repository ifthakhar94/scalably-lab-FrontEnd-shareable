          ...
          <Container className={commonMediaStyles.container_content}>
            ...
            <div className={commonMediaStyles.newsAsset_profile_content}>
              <div className={commonMediaStyles.newsAsset_profile_profilePic}>
                {/* <Image src={asset_icon} alt="News Asset Icon" width={40} height={40} /> */}
              </div>
              <div className={commonMediaStyles.newsAsset_profile_right}>
                <p className={commonMediaStyles.newsprofile_right_title}>Trippy ADA</p>
                <p className={commonMediaStyles.newsprofile_right_date}>{t('medianewsAsset.finalDate')}：2023/02/29</p>
                <p className={commonMediaStyles.newsprofile_right_description}>
                  アートベースのCNFTコレクションで、カルダノにユニークなアートをもたらすとともに、サイケデリックに関する教育や認識を高めることを目的としています。
                </p>
                <div className={commonMediaStyles.NewsOwner_info}>
                  <div className={commonMediaStyles.NewsOwner_pic}>{/* <Image src={asset_icon} alt="NewsOwner" /> */}</div>
